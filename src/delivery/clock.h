#ifndef POMELO_DELIVERY_CLOCK_SRC_H
#define POMELO_DELIVERY_CLOCK_SRC_H
#include <stdint.h>
#include <stdbool.h>
...
typedef enum pomelo_delivery_clock_sync_level_e {
    POMELO_DELIVERY_CLOCK_SYNC_LEVEL_HIGH,
    POMELO_DELIVERY_CLOCK_SYNC_LEVEL_MEDIUM,
    POMELO_DELIVERY_CLOCK_SYNC_LEVEL_LOW
} pomelo_delivery_clock_sync_level;



/// @brief Protocol clock
typedef struct pomelo_delivery_clock_s pomelo_delivery_clock_t;


struct pomelo_delivery_clock_s {
    /// @brief Offset
    ...
    pomelo_delivery_clock_sync_level level;
...
void pomelo_delivery_clock_set(pomelo_delivery_clock_t * clock, uint64_t value);
...
#endif
#endif // POMELO_DELIVERY_CLOCK_SRC_H
