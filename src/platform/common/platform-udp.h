...
struct pomelo_platform_udp_s {
    ...
    /// @brief The node in sockets list
...
/// @brief Bind UDP socket with address
...
/// @brief Connect UDP socket to address
...
/// @brief Send message to UDP Socket
...
/// @brief Set UDP Socket callbacks
